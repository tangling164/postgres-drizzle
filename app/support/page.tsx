...
export const metadata: Metadata = { title: 'Support', description: 'Get help with FormAlert setup, License Codes, payments, and refunds.', alternates: { canonical: '/support' } }
  ...
  return (
    <main className="page-container narrow-section">
      ...
      <div className="support-grid">
        ...
        <article><EnvelopeSimple weight="fill" /><h2>Contact Support</h2><p>For License Code resets, payment questions, or unresolved setup issues.</p><a href={`mailto:${siteConfig.supportEmail}`}>{siteConfig.supportEmail}</a></article>
